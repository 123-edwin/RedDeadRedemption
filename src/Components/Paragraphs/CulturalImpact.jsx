  ...
  return (
    <div className="Text">
      ...
      <p>
        ...
        Morgan y la caída de la banda de Dutch Van der Linde fue aclamada como
        una de las mejores en la historia de los videojuegos, y muchos
        consideran que el título ocupó un lugar destacado en la historia de la
        industria, siendo un claro ejemplo de cómo los videojuegos pueden ser
        una forma de arte.
      </p>
      <div className="Links">
      <a
